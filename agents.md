...
| `a choice takes N tokens and needs one more of context`                                      | an `eval-choice` prompt longer than the model's declared context      | lower `--shots`, or score a checkpoint with a longer context; scoring it truncated would flatter that option: `docs/optimization.md` lever 24                                                                                                                               |
