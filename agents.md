...
| `no GPU adapter found, and <command> needs one`                                                                           | the machine has no usable GPU adapter                                                                                                                               | there is no CPU execution path, by decision rather than omission. For training on a CPU, use `transformers` with `peft`: readme.md, "Training on a CPU"                                                                                                                                                                                                                                                    |
