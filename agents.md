...
| `GGUF tensor "X" has dims [...], but this model wants [...]`                                                              | the checkpoint's stored tensor dims disagree with its own metadata config                         | the file is corrupt or was written by something else; re-export it. Before this check a transposed tensor loaded silently and the model generated noise: `docs/optimization.md` lever 33                                                                                           |
