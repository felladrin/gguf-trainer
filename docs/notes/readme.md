...
For how to use the trainer, read [agents.md](../../agents.md). For the current design rationale and the measured performance levers, read [design.md](../design.md), [optimization.md](../optimization.md) and [correctness.md](../correctness.md), which are maintained.
