...
The correctness and robustness levers live in [correctness.md](correctness.md), split out on
2026-09-10 when they had grown past half of this file. **Lever numbers are stable ids, not an
ordering.** They are never reused and never renumbered, they are not sequential within either file,
and a number tells you nothing about which file holds it. If a lever you are looking for is not
here, it is in the other one:
...
## Measuring on this box (read before quoting any number)
...
Moved to [correctness.md](correctness.md) on 2026-09-10: levers 5 to 7 and 22 to 46 and 48, which
had grown to more than half of this file. Lever numbers did not change and never do. Lever 47 stayed
here, under "Measuring on this box", because it governs how to read every number in this file rather
